  ...
  return (
    <div className="flex h-full bg-gray-100 ">
      <aside className="w-64 bg-blue-100 p-5 ">
        ...
        <ShieldCheck className="h-10 w-10"></ShieldCheck>
          ...
          <button onClick={() => { window.location.pathname = '/'; }} className="w-full">
            <div className="flex items-center justify-between  px-4 py-2 rounded-md">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span>Home</span>
                {paramName==="" &&    <ChevronRightIcon className="h-4 w-4" />
}
              </div>
            </div>
          </button>
            ...
            <button onClick={() => { window.location.pathname = '/channelform'; }} className="w-full">
              ...
              <div className="flex items-center justify-between px-4 py-2 rounded-md text-gray-700 hover:bg-blue-200">
                <div className="flex items-center space-x-2">
                  ...
                  {paramName==="channelform"  &&   <ChevronRightIcon className="h-4 w-4" />}
                </div>
              </div>
            </button>
            <div className="mt-2 space-y-2">
              <button onClick={() => { window.location.pathname = '/recommendation'; }} className="w-full">
                <div className="flex items-center justify-between px-4 py-2 rounded-md text-gray-700 hover:bg-blue-200">
                  <div className="flex items-center space-x-2">
              ...
              <button onClick={() => { window.location.pathname = '/contactus'; }} className="w-full">
                <div className="flex items-center justify-between px-4 py-2 rounded-md text-gray-700 hover:bg-blue-200">
                  <div className="flex items-center space-x-2">
